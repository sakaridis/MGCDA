...
# Parameters.
DATASETS_NAME="cityscapes_resize_360_2_darkzurichtwilight_resize_360"
...
ln -s ${DARK_ZURICH_ROOT_DIR}/rgb_crop_bottom_resize_360/train/twilight datasets/${DATASETS_NAME}/trainB
ln -s ${DARK_ZURICH_ROOT_DIR}/rgb_crop_bottom_resize_360/train/twilight datasets/${DATASETS_NAME}/testB
...
# Test CycleGAN for translating downsized 360x720 Cityscapes images to Dark Zurich-twilight domain.
...
--preprocess none \
--num_test 3500 \
--results_dir ${OUTPUT_ROOT_DIR}/leftImg8bit_trainval_dark_CycleGAN_DarkZurichTwilight_resize_360
