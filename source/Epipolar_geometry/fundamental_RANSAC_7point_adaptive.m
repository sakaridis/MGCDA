...
function [in1, in2, out1, out2, m, F] = fundamental_RANSAC_7point_adaptive(...
    xy1, xy2, threshold, p)
%FUNDAMENTAL_RANSAC_7POINT_ADAPTIVE  Adaptive RANSAC with 7-point
%correspondences for automatic calculation of the fundamental matrix from noisy
%measurements containing outliers.
%
% INPUTS:
%
